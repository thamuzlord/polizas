  ...
  class PolizasController {
    ...
    public function modificarDocumentoRequerido()
    {
     ...
     public function guardarCliente() {
      ...
      $email = $_POST["email"];
      $Datos = $this->PolizasDao->guardarCliente($idCliente,$NIT,$primerNombre,$segundoNombre,$primerApellido,$segundoApellido,$telefono,$direccion,$email,$tipoPersona);
      $return["Error"] = $error;
      $return["Mensaje"] = $mensaje;
      $return["Datos"] = $Datos;
      echo json_encode($return);
     ...
     public function guardarAseguradora() {
      ...
      $contactoAseguradora = $_POST["contactoAseguradora"];
      $telefonoContactoAseguradora = $_POST["telefonoContactoAseguradora"];
      $correoContactoAseguradora = $_POST["correoContactoAseguradora"];
      $Datos = $this->PolizasDao->guardarAseguradora($idAseguradora,$nombreAseguradora,$telefonoContactoAseguradora,$contactoAseguradora,$correoContactoAseguradora);
      $return["Error"] = $error;
      $return["Mensaje"] = $mensaje;
      $return["Datos"] = $Datos;
      echo json_encode($return);
